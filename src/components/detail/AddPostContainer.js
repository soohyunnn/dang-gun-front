            ...
            <article id="content">
                ...
                <form>              
                    <section id="add-post">
                        ...
                        <input className="title" name="title" type="text" placeholder="제목을 입력해 주세요." onChange={onChange}/>
                        <input className="price" name="price" type="text" placeholder="금액을 입력해 주세요." onChange={onChange}/>
                        <textarea className="content" name="content" placeholder="내용을 입력하세요." onChange={onChange}></textarea>
